const API_ENDPOINT = "https://k9n8lu6g1k.execute-api.us-east-1.amazonaws.com/prod";
//const DEBUG = false;
...
const renderPhotos = async () => {
  ...
  deleteControl.setAttribute("id", "delete");
  deleteControl.setAttribute("type", "button");
  deleteControl.innerHTML = "Delete";
  deleteControl.addEventListener("click", deletePhoto);
